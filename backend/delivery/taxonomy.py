...
TAXONOMY = {
    "financial": {
        ...
        "subsectors": [
            ...
            {"key": "insurer", "label": "Seguradora", "modules": ["lgpd"], "regulators": ["SUSEP", "CNSP"], "norm": "Circular SUSEP 638/2021"},
            {"key": "reinsurer", "label": "Resseguradora", "modules": ["lgpd"], "regulators": ["SUSEP"], "norm": "Circular SUSEP 638/2021"},
            {"key": "insurance_broker", "label": "Corretora de seguros", "modules": ["lgpd"], "regulators": ["SUSEP"], "norm": "LGPD (base)"},
            {"key": "capitalization", "label": "Capitalização", "modules": ["lgpd"], "regulators": ["SUSEP"], "norm": "Circular SUSEP 638/2021"},
            {"key": "pension_open", "label": "Previdência aberta (EAPC)", "modules": ["lgpd"], "regulators": ["SUSEP", "CNSP"], "norm": "Circular SUSEP 638/2021"},
