...
READER_PERMISSIONS_LIST = [
    ...
    "view_plantask",
    "view_timeentry",
    "view_incidentresponseplan",
    "view_incidentphase",
    "view_incidentresponsetask",
    "view_incidentrole",
    "view_incidentstakeholder",
    "view_regulatorynotification",
    "view_incidentcost",
    "view_incidenttimeentry",
...
ANALYST_PERMISSIONS_LIST = [
    ...
    "change_timeentry",
    "delete_timeentry",
    "add_incidentresponseplan",
    "view_incidentresponseplan",
    "change_incidentresponseplan",
    "delete_incidentresponseplan",
    "add_incidentphase",
    "view_incidentphase",
    "change_incidentphase",
    "delete_incidentphase",
    "add_incidentresponsetask",
    "view_incidentresponsetask",
    "change_incidentresponsetask",
    "delete_incidentresponsetask",
    "add_incidentrole",
    "view_incidentrole",
    "change_incidentrole",
    "delete_incidentrole",
    "add_incidentstakeholder",
    "view_incidentstakeholder",
    "change_incidentstakeholder",
    "delete_incidentstakeholder",
    "add_regulatorynotification",
    "view_regulatorynotification",
    "change_regulatorynotification",
    "delete_regulatorynotification",
    "add_incidentcost",
    "view_incidentcost",
    "change_incidentcost",
    "delete_incidentcost",
    "add_incidenttimeentry",
    "view_incidenttimeentry",
    "change_incidenttimeentry",
    "delete_incidenttimeentry",
    "view_customfielddefinition",
    "view_compliance_assessment_full",
    "view_object_audittrail",
    "add_filteringlabel",
