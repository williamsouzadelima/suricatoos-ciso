...
<div class="ds-foot border-t pt-2.5">
	<div class="flex flex-row items-center justify-between">
		<div class="flex flex-col w-3/4">
			{#if page.data.user}
				<span
					class="ds-user text-sm whitespace-nowrap overflow-hidden truncate w-full"
				...
				<span
					class="ds-user-sub font-normal text-xs whitespace-nowrap truncate mr-2 w-full"
			...
			<div class="relative">
				...
				{#if openState}
					...
					>
						...
						{/if}
						<a
							href="https://github.com/williamsouzadelima/suricatoos-ciso"
							target="_blank"
							class="unstyled cursor-pointer flex items-center gap-2 w-full px-4 py-2.5 text-left text-sm hover:bg-surface-200-800 disabled:text-surface-400-600 text-surface-950-50"
